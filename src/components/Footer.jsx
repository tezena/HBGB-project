    ...
    <div className='bg-dark d-flex flex-column justify-content-center'>
      ...
      <div className='d-flex flex-row justify-content-evenly w-50'>
        <div className='d-flex flex-column p-3'>
          ...
          <a  className="text-secondary text-decoration-none" href="#">About HBGB</a>
          <a  className="text-secondary text-decoration-none" href="#">Services</a>
          <a className="text-secondary text-decoration-none" href="#">Contact Us</a>
        </div>
      ...
      <div className='bg-white w-40 h-40 mx-5' style={{ width: '300px',height:'300px', backgroundColor:"white"}}>
